  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        MyRoutes.sendnotificationRoute: (context) =>
            SendNotificationScreen(title: 'Flutter Local Notifications'),
        ...
        MyRoutes.ChangepasswordTheme2Route: (context) =>
            ChangePasswordPage_theme2(),
        MyRoutes.ChangepasswordTheme3Route: (context) =>
            ChangePasswordPage_theme3(),
        ...
        MyRoutes.sendNotificationsTheme2Route: (context) =>
            NotificationScreentheme_2(),
        MyRoutes.sendNotificationsTheme3Route: (context) =>
            NotificationScreentheme_3(),
        ...
        MyRoutes.CurvedNavBarWhiteRoute: (context) =>
            WhiteBottomNavigationBar(),
        MyRoutes.GameCurvedNavBarWhiteRoute: (context) =>
            GameBottomNavigationBar(),
        MyRoutes.LockCurvedNavBarWhiteRoute: (context) =>
            MoneyBottomNavigationBar(),
        MyRoutes.Theme2CurvedNavBarWhiteRoute: (context) =>
            Theme2BottomNavigationBar(),
        MyRoutes.Theme3CurvedNavBarWhiteRoute: (context) =>
            Theme3BottomNavigationBar(),
