        ...
        child: AlertDialog(
         ...
         title: Column(
           children: [
             ...
             SizedBox(height: 20),
                 Center(
               child: Text('Sorry, You have not acheived the Target!',
               style: TextStyle(
                color: Colors.white,
          ...
          child: Row(
            ...
            children: [
              ...
              borderRadius: BorderRadius.all(Radius.circular(8.0)),
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: Color.fromARGB(255, 35, 24, 80).withOpacity(0.5),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Get a chance to have 20% off on the bills of nearby restaurant Chilli.",
                      style: TextStyle(
                        color: Colors.black,
                    ...
                    Padding(
                      ...
                      child: Center(
                        child: Text("Use Code to claim reward",
                        style: TextStyle(
                          color: Color(0xFF674AEF),
                          fontWeight: FontWeight.bold
                        ),
              ...
              borderRadius: BorderRadius.all(Radius.circular(8.0)),
              image: DecorationImage(
                image: AssetImage('images/cartoon-5.png',),
                fit: BoxFit.cover,
                opacity: 0.2
                ),
                ),
                child: Column(
                  ...
                  children: [
                     ...
                     Center(
                       child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text("You have just earned Rs.10 in your wallet, Keep Playing to earn more!!",
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Center(
                  child: Stack(
                  children: [
                    MyBird(birdYaxis: birdYaxis,birdWidth: birdWidth, birdheight: birdheight),
                  Container(
