      ...
      body:Column(
        ...
        Padding(
          ...
          Padding(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
             children: [ 
              ...
              color: _hasBeenPressedAmerican ? Color(0xFF674AEF) : Colors.white,
              child: Padding(
              padding: EdgeInsets.all(20),
              child: Text("American Express Bank",
              style: TextStyle(
             color: _hasBeenPressedAmerican ? Colors.white : Colors.black,
                ),
              ),
              ),
            ),
            ...
            InkWell(
              ...
              elevation: 10,
              borderRadius: BorderRadius.circular(30),
              color: _hasBeenPressed ? Color(0xFF674AEF) : Colors.white,
              child: Padding(
              padding: EdgeInsets.all(20),
          ...
          InkWell(
              ...
              elevation: 10,
              borderRadius: BorderRadius.circular(30),
              color: _hasBeenPressedHDFC ? Color(0xFF674AEF) : Colors.white,
              child: Padding(
              padding: EdgeInsets.all(20),
              child: Text("HDFC Bank",
              style: TextStyle(
             color: _hasBeenPressedHDFC ? Colors.white : Colors.black,
                ),
              ),
              ),
            ),
            ...
            InkWell(
              ...
              elevation: 10,
              borderRadius: BorderRadius.circular(30),
              color: _hasBeenPressedSBI ? Color(0xFF674AEF) : Colors.white,
              child: Padding(
              padding: EdgeInsets.all(20),
              child: Text("SBI Bank",
              style: TextStyle(
             color: _hasBeenPressedSBI ? Colors.white : Colors.black,
                ),
              ),
              ),
            ),
             ...
             InkWell(
              ...
              elevation: 10,
              borderRadius: BorderRadius.circular(30),
              color: _hasBeenPressedAxis ? Color(0xFF674AEF) : Colors.white,
              child: Padding(
              padding: EdgeInsets.all(20),
              child: Text("Axis Bank",
              style: TextStyle(
             color: _hasBeenPressedAxis ? Colors.white : Colors.black,
                ),
              ),
              ),
            ),
            ...
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
             children: [ 
              ...
              elevation: 10,
              borderRadius: BorderRadius.circular(30),
              color: _hasBeenPressedPunjab ? Color(0xFF674AEF) : Colors.white,
              child: Padding(
              padding: EdgeInsets.all(20),
              child: Text("Bank Of Baroda",
              style: TextStyle(
             color: _hasBeenPressedPunjab ? Colors.white : Colors.black,
                ),
              ),
              ),
            ),
          ...
          InkWell(
              ...
              elevation: 10,
              borderRadius: BorderRadius.circular(30),
              color: _hasBeenPressedBaroda ? Color(0xFF674AEF) : Colors.white,
              child: Padding(
              padding: EdgeInsets.all(20),
              child: Text("Punjab Bank",
              style: TextStyle(
             color: _hasBeenPressedBaroda ? Colors.white : Colors.black,
                ),
              ),
              ),
            ),
          ...
          InkWell(
              ...
              elevation: 10,
              borderRadius: BorderRadius.circular(30),
              color: _hasBeenPressedCanara ? Color(0xFF674AEF) : Colors.white,
              child: Padding(
              padding: EdgeInsets.all(20),
              child: Text("Canara Bank",
              style: TextStyle(
             color: _hasBeenPressedCanara ? Colors.white : Colors.black,
                ),
              ),
              ),
            ),
