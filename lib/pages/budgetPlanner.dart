  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        children: [ 
          Text("Budget Planner", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600),),
         InkWell(
          onTap: () {
      ...
      body:DefaultTabController(
        ...
        child: Column(
          ...
          budget.isEmpty ? const Text('No More Budgets') :
           Expanded(
             child: ListView.builder(
              itemCount: budget.length,
              itemBuilder: (context, data) => getRow(data),
             ),
           ),
            ...
            padding: const EdgeInsets.only(left: 20, right: 20),
            child: Column(
                children: List.generate(budget_json_weekly.length, (index) {
              return Padding(
                padding: const EdgeInsets.only(bottom: 20),
                child: Container(
                  width: double.infinity,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(
                                 budget_json_weekly[index]['price'],
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                                  ),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(top: 3),
                                  child: Text(
                                    budget_json_weekly[index]['label_percentage'],
                                    style: TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 13,
                                        color:
                        ...
                        Stack(
                          children: [
                            ...
                            Container(
                              width: (size.width - 40) *
                                  budget_json_weekly[index]['percentage'],
                              height: 4,
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
                                  color: Color(0xFF674AEF)),
            ...
            padding: const EdgeInsets.only(left: 20, right: 20),
            child: Column(
                children: List.generate(budget_json_monthly.length, (index) {
              return Padding(
                padding: const EdgeInsets.only(bottom: 20),
                child: Container(
                  width: double.infinity,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(
                                  budget_json_monthly[index]['price'],
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                                  ),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(top: 3),
                                  child: Text(
                                    budget_json_monthly[index]['label_percentage'],
                                    style: TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 13,
                                        color:
                        ...
                        Stack(
                          children: [
                            ...
                            Container(
                              width: (size.width - 40) *
                                 budget_json_monthly[index]['percentage'],
                              height: 4,
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
                                  color: Color(0xFF674AEF)),
            ...
            padding: const EdgeInsets.only(left: 20, right: 20),
            child: Column(
                children: List.generate(budget_json_yearly.length, (index) {
              return Padding(
                padding: const EdgeInsets.only(bottom: 20),
                child: Container(
                  width: double.infinity,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(
                                  budget_json_yearly[index]['price'],
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                                  ),
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(top: 3),
                                  child: Text(
                                    budget_json_yearly[index]['label_percentage'],
                                    style: TextStyle(
                                        fontWeight: FontWeight.w500,
                                        fontSize: 13,
                                        color:
                        ...
                        Stack(
                          children: [
                            ...
                            Container(
                              width: (size.width - 40) *
                                  budget_json_yearly[index]['percentage'],
                              height: 4,
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
                                  color: Color(0xFF674AEF)),
