  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Transaction History", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600),),
        leading: IconButton(
        onPressed: () {
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        width: (size.width - 20),
                        height: 160,
                        child:  const ExpenseGraphDesign_weekly(), 
                      ),
                    )
                  ],
                ),
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        width: (size.width - 20),
                        height: 160,
                        child:  const ExpenseGraphDesign_monthly(), 
                      ),
                    )
                  ],
                ),
                ...
                return Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Column(
                        children: List.generate(monthly.length, (index) {
                          return Column(
                            children: [ 
                    Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        width: (size.width - 20),
                        height: 160,
                        child:  const ExpenseGraphDesign_yearly(), 
                      ),
                    )
                  ],
                ),
                ...
                return Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      padding: const EdgeInsets.only(left: 20, right: 20),
                        child: Column(
                        children: List.generate(yearly.length, (index) {
                          return Column(
                            children: [ 
                    Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
