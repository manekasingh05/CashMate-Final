...
import 'package:cashmate_vscode/components/NavBar_theme2.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:cashmate_vscode/pages/addMoneyinWallet.dart';

class HomeScreentheme2 extends StatefulWidget {

  const HomeScreentheme2({super.key});

  @override
  State<HomeScreentheme2> createState() => _Homescreentheme2State();
}

class _Homescreentheme2State extends State<HomeScreentheme2> {
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          children: [
                           InkWell(
                            onTap: (){
                              Navigator.pushNamed(context, MyRoutes.selectContactTheme2Route);
                            },
                           child: Column(children: [ Card(
                              elevation: 10,
                              shape: RoundedRectangleBorder(
                       ...
                       InkWell(
                           ...
                           child: Column(children: [ Card(
                            ...
                            InkWell(
                            onTap: (){
                              Navigator.pushNamed(context, MyRoutes.sendNotificationsTheme2Route);
                            },
                           child: Column(children: [ Card(
                              elevation: 10,
                              shape: RoundedRectangleBorder(
