...
import 'package:cashmate_vscode/components/NavBar_theme3.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:cashmate_vscode/pages/addMoneyinWallet.dart';

class HomeScreentheme3 extends StatefulWidget {

  const HomeScreentheme3({super.key});

  @override
  State<HomeScreentheme3> createState() => _Homescreentheme3State();
}

class _Homescreentheme3State extends State<HomeScreentheme3> {
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  boxShadow: [
                                    BoxShadow(
                                      color: Color(0xFF674AEF).withOpacity(0.8),
                                      offset: Offset(0,0),
                                      blurRadius: 20,
                                      spreadRadius: 3,
                                    ),
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                            onTap: (){
                              Navigator.pushNamed(context, MyRoutes.GameCurvedNavBarWhiteRoute);
                            },
                           child: Column(children: [ Card(
                              elevation: 10,
                              shape: RoundedRectangleBorder(
                          ...
                          children: [
                           InkWell(
                            onTap: (){
                              Navigator.pushNamed(context, MyRoutes.selectContactsTheme3Route);
                            },
                           child: Column(children: [ Card(
                              elevation: 10,
                              shape: RoundedRectangleBorder(
                       ...
                       InkWell(
                            onTap: (){
                              Navigator.pushNamed(context, MyRoutes.addCardRoute);
                            },
                           child: Column(children: [ Card(
                              elevation: 10,
                              shape: RoundedRectangleBorder(
                            ...
                            InkWell(
                            onTap: (){
                              Navigator.pushNamed(context, MyRoutes.sendNotificationsTheme3Route);
                            },
                           child: Column(children: [ Card(
                              elevation: 10,
                              shape: RoundedRectangleBorder(
