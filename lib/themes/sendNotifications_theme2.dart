...
class NotificationScreentheme_2 extends StatefulWidget {
  const NotificationScreentheme_2({ Key? key }) : super(key: key);

  @override
  _NotificationScreentheme_2State createState() => _NotificationScreentheme_2State();
}

class _NotificationScreentheme_2State extends State<NotificationScreentheme_2> {
