...
class SettingsPageUItheme3 extends StatefulWidget {
 const SettingsPageUItheme3({super.key});

  @override
 _SettingsPageUItheme3State createState() => _SettingsPageUItheme3State();
}

class _SettingsPageUItheme3State extends State<SettingsPageUItheme3> {
...
valNotify3=newValue3;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: Image.asset("images/cartoon-2.png",
       width: 190,),
      ...
      InkWell(
      onTap: () {
        Navigator.pushNamed(context, MyRoutes.ChangepasswordTheme3Route);
      },  
      child:Padding(
        padding: EdgeInsets.symmetric(vertical: 8,horizontal: 20),
         child:Text("Change Password",
          ...
          Divider(height: 20,thickness: 1),
          SizedBox(height: 10),
          buildNotificationOption("Theme Activated", valNotify1,onChangeFunctional1),
              buildNotificationOption("Turn On Notifications", valNotify3,onChangeFunctional3),
              SizedBox(height: 50),
              Center(
