...
class NotificationScreentheme_3 extends StatefulWidget {
  const NotificationScreentheme_3({ Key? key }) : super(key: key);

  @override
  _NotificationScreentheme_3State createState() => _NotificationScreentheme_3State();
}

class _NotificationScreentheme_3State extends State<NotificationScreentheme_3> {
...
final List<User> _users = [
    ...
    User('Rahul Roy', '@rahul', 'images/profile6.avif', false),
          ...
          itemBuilder: (context, index) {
            return Slidable(
              ...
              child: userComponent(user: _foundedUsers[index]),
                ...
                child: InkWell(
                  onTap: () {
                     Navigator.pushNamed(context, MyRoutes.sendnotificationRoute);
                  },
                  child: Container(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: user.isFollowedByMe ? Color(0xFF674AEF) : Color(0xffffff),
                borderRadius: BorderRadius.circular(5),
                border: Border.all(color: user.isFollowedByMe ? Colors.transparent : Colors.grey.shade700,)
              ),
              child: Center(
                child: Text(user.isFollowedByMe ? 'Selected' : 'Select', style: TextStyle(color: user.isFollowedByMe ? Colors.white : Colors.white))
              )
            ),
          )
        ],
