import 'package:cashmate_vscode/models/Charts.dart';
import 'package:cashmate_vscode/models/currency.dart';
import 'package:cashmate_vscode/models/currency_info.dart';
import 'package:cashmate_vscode/models/exchange_rate.dart';
import 'package:cashmate_vscode/pages/responsive.dart';
import 'package:cashmate_vscode/services/currency_service.dart';
import 'package:cashmate_vscode/Widgets/chart_widget.dart';
import 'package:cashmate_vscode/Widgets/trending_widget.dart';
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    ...
                                    style: ElevatedButton.styleFrom(
                                    backgroundColor: Color(0xFF674AEF), // Background color
                                    ),
                                  child: Container(
                                    width: double.infinity,
                                    padding: EdgeInsets.all(15),
                                  ...
                                  child: DataTable(
                                    ...
                                    columns: [
                                        ...
                                        child: Row(
                                          children: [
                                            ConstrainedBox(
                                              ...
                                              child: Image.asset('assets/flags/$_fromCurrency.png'),
                                            ),
                                            SizedBox(width: 5),
                                            Text(
                                              '$_fromCurrency',
                                      ...
                                      DataColumn(
                                        label: Text(
                                          'Last Price',
                                          style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF674AEF)),
                                        ),
                                      ),
                                      DataColumn(
                                        label: Text(
                          ...
                          child: Row(
                            children: [
                              ConstrainedBox(
                                ...
                                child: Image.asset('assets/flags/${c.code}.png'.toLowerCase()),
                              ),
                              SizedBox(width: 5),
                              Text(
                                !isMobile
      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            onChanged: (value) {
              setState(() {
                if (value.isNotEmpty && value != null)   //added line
                {
