...
class Theme2BottomNavigationBar extends StatefulWidget {
  @override
  _Theme2BottomNavigationBarState createState() => _Theme2BottomNavigationBarState();
}

class _Theme2BottomNavigationBarState extends State<Theme2BottomNavigationBar> {

  GlobalKey<CurvedNavigationBarState> _bottomNavigationKey = GlobalKey();

  final screens = [HomeScreentheme2(), CurrencyExchange(), SendMoneyPage(), moneyLock(), GameLevelScreen()];
