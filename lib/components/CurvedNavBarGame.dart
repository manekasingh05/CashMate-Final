...
class GameBottomNavigationBar extends StatefulWidget {
  @override
  _GameBottomNavigationBarState createState() => _GameBottomNavigationBarState();
}

class _GameBottomNavigationBarState extends State<GameBottomNavigationBar> {

  GlobalKey<CurvedNavigationBarState> _bottomNavigationKey = GlobalKey();

  final screens = [HomeScreen(), CurrencyExchange(), SendMoneyPage(), moneyLock(), GameLevelScreen()];
