...
class NavBartheme2 extends StatelessWidget {
      ...
      child: ListView(
        ...
        children: [
          UserAccountsDrawerHeader(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                  fit: BoxFit.cover, image: AssetImage('images/theme2.jpg')),
            ),
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pushNamed(context, MyRoutes.selectTheme2Route);
            },
          ),
          Divider(),
          ListTile(
                  ...
                  return AlertDialog(
                    ...
                    actions: <Widget>[
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(
                              context, MyRoutes.homePageTheme2Route);
                        },
                      ),
                    ],
                  );
